...
export default function Projects(props: projectProps) {
  ...
  return (
    <Div
      style={{
        fontSize: `${parseInt(props.fontSize) * scaleFactor}`,
        width: `${515 * scaleFactor}pt`,
      }}
    >
            ...
            return (
              <Div style={{}} key={index}>
                <Div style={{ display: "flex", flexDirection: "row" }}>
                  ...
                  >
                    <p style={props.projectStyle}>
                      <a href={link}>{project !== "" ? `${project}` : null}</a>
                    </p>
                ...
                <Div
                  /*</Div>dangerouslySetInnerHTML={{ __html: description }}*/ style={{
                    marginTop: `${3 * scaleFactor}pt`,
                    maxWidth: `${390 * scaleFactor}pt`,
                    display: "flex",
                    flexDirection: "column",
                    gap: `${1 * scaleFactor}pt`,
